...
//    @Test(dataProvider = "testName", dataProviderClass = AbstractServiceTestImpl.class)
    public void create(String testName) throws Exception {
        ...
        PottagClient client = new PottagClient();
        String identifier = createIdentifier();
        PoxPayloadOut multipart = createPottagInstance(identifier);
        String newID = null;
...
//    dependsOnMethods = {"create"})
    public void read(String testName) throws Exception {
        ...
        if (payloadInputPart != null) {
            pottagCommon = (PottagsCommon) payloadInputPart.getBody();
        }
...
//    dependsOnMethods = {"read"})
    public void update(String testName) throws Exception {
        ...
        pottagCommon.setFamily("updated-" + pottagCommon.getFamily());
        pottagCommon.setLabelData("updated-" + pottagCommon.getLabelData());
        if (logger.isDebugEnabled()) {
        ...
        PayloadOutputPart commonPart = output.addPart(client.getCommonPartName(), pottagCommon);
        ...
        PottagsCommon updatedPottagCommon = null;
        if (payloadInputPart != null) {
            updatedPottagCommon = (PottagsCommon) payloadInputPart.getBody();
        }
        Assert.assertNotNull(updatedPottagCommon);

        // Check selected fields in the updated common part.
        Assert.assertEquals(updatedPottagCommon.getFamily(),
                pottagCommon.getFamily(),
...
//    dependsOnMethods = {"update", "testSubmitRequest"})
    public void updateNonExistent(String testName) throws Exception {
        ...
        PottagClient client = new PottagClient();
        PoxPayloadOut multipart = createPottagInstance(NON_EXISTENT_ID);
...
//    @Test(dependsOnMethods = {"create", "read"})
     ...
     */
    private PoxPayloadOut createPottagInstance(String identifier) {
	...
	@Override
	protected void compareUpdatedInstances(PottagsCommon original,
			PottagsCommon updated) throws Exception {
		// TODO Auto-generated method stub
