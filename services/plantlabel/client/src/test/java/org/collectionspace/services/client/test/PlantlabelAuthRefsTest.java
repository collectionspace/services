...
/**
 * PlantlabelAuthRefsTest, carries out Authority References tests against a
 * deployed and running Plantlabel (aka Plant Label) Service.
 *
 * $LastChangedRevision$
 * $LastChangedDate$
 */
public class PlantlabelAuthRefsTest extends BaseServiceTest<AbstractCommonList> {

    private final String CLASS_NAME = PlantlabelAuthRefsTest.class.getName();
    ...
    private List<String> plantlabelIdsCreated = new ArrayList<String>();
    ...
    public void createWithAuthRefs(String testName) throws Exception {
        ...
        try {
	        ...
	        plantlabelIdsCreated.add(extractId(response));
        } finally {
    ...
    public void readAndCheckAuthRefs(String testName) throws Exception {
        ...
        // Submit the request to the service and store the response.
        PlantlabelClient plantlabelClient = new PlantlabelClient();
        ClientResponse<String> res = plantlabelClient.read(knownResourceId);
        PlantlabelsCommon plantlabelCommon = null;
        try {
	        assertStatusCode(res, testName);
	        // Extract the common part from the response.
	        PoxPayloadIn input = new PoxPayloadIn(res.getEntity());
	        plantlabelCommon = (PlantlabelsCommon) extractPart(input,
	            plantlabelClient.getCommonPartName(), PlantlabelsCommon.class);
        ...
        ClientResponse<AuthorityRefList> res2 = plantlabelClient.getAuthorityRefs(knownResourceId);
    ...
    public void cleanUp() {
        ...
        if (personAuthCSID != null) {
	        ...
	        for (String resourceId : plantlabelIdsCreated) {
	            // Note: Any non-success responses are ignored and not reported.
	            response = plantlabelClient.delete(resourceId); // alternative to plantlabelClient.delete(resourceId).releaseConnection();
	            response.releaseConnection();
	        }
        }
    }
