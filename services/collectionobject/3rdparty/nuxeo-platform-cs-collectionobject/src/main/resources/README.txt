Copy the following Nuxeo field type declarations to
$JBOSS_HOME/templates/collectionspace_mysql/config/default-repository-config.xml
Insert into the existing <schema> element.
          ...
          <!-- Note: schema name is currently singular -->
