...
public class UpdateObjectAndCrateLocationBatchJob extends UpdateObjectLocationBatchJob {
    ...
    protected long updateCollectionObjectValues(NuxeoBasedResource collectionObjectResource,
        ...
        previousComputedCurrentLocation = getFieldElementValue(collectionObjectPayload,
                                                               ...
                                                               COLLECTIONOBJECTS_COMMON_NAMESPACE,
        ...
        previousComputedCrate = getFieldElementValue(collectionObjectPayload,
                                                     COLLECTIONOBJECTS_ANTHROPOLOGY_SCHEMA_NAME,
                                                     COLLECTIONOBJECTS_ANTHROPOLOGY_NAMESPACE,
        ...
        collectionObjectResource.update(getServiceContext(), resourcemap, null, collectionObjectCsid,
                                        collectionObjectUpdatePayload);
        numUpdated++;
        logger.trace("Computed current location value for CollectionObject {}  was set to {}",
                     collectionObjectCsid, computedCurrentLocation);
        logger.trace("Computed crate value for CollectionObject {} was set to {}", collectionObjectCsid, computedCrate);
        return numUpdated;
    }
}
