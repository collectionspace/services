 ...
 * - A new client object is instantiated only once, and then is re-used repeatedly
 *   for submitting each new 'create' request.
 * - The client's HTTP connection is formally closed, and its resources released,
 *   only once, after the last 'create' request has been submitted.
 * 
 * @version $Revision:$
 */
